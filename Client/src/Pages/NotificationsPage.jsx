...
const PREFERENCE_LABELS = {
  message: "شخص مهتم بعقارك (اتصال / واتساب)",
...
function PreferencesPanel() {
  ...
  return (
    <div className="mt-6 overflow-hidden rounded-[24px] border border-[#e7e2d7] bg-white shadow-sm">
      <button
        onClick={() => setOpen((v) => !v)}
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <div className="space-y-1 border-t border-[#f1efe8] px-5 py-4">
              {!prefs && (
